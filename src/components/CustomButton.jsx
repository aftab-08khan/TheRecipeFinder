...
const CustomButton = ({
  ...
  const baseClasses =
    "inline-flex items-center justify-center gap-2 text-captialize transition-all duration-300 ease-in-out transform focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-opacity-50 mb-3";
